...
public class SourceAnnotataionTestDemo
{
	...
	void withAllEnumValues(TimeUnit timeUnit)
	{
	...
	void withSomeEnumValues(TimeUnit timeUnit)
	{
		// excuted once for TimeUnit.NANOSECONDS
